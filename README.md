...
- **[DiscordBuddy](DiscordBuddy/)** — Discord Rich Presence for After Effects: shows *"Playing Adobe After Effects"* with your current `.aep` and comp on your Discord profile. See [DiscordBuddy/README.md](DiscordBuddy/README.md) for the 2-minute setup.
